...
function EFFECT:Render()
	...
	for i = 1, 3 do
		render.DrawBeam(self.StartPos - norm, self.EndPos, 8, texcoord, texcoord + self.Length / 128, color_white) -- Start -- End -- Width -- Start tex coord -- End tex coord -- Color (optional)
	end
