-- https://steamcommunity.com/sharedfiles/filedetails/?id=1681190762
-- Original author: dudegibbs
AddCSLuaFile()
...
if CLIENT then
	...
	SWEP.EquipMenuData = {
		type = "item_weapon",
		desc = "Left click to push. Right click to pull.\n\nInfinite ammo, but slow to fire."
	}
...
local CHARGE_FORCE_UP_MAX = 1000
